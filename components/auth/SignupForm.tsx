...
export default function SignupForm({ onSignup, onSwitch }: { onSignup: (u: any) => void, onSwitch: () => void }) {
  ...
  return (
    <div style={{ background: `linear-gradient(135deg,${colors.bg},${colors.bg2})`, minHeight: '100vh' }}
      ...
      <div style={{ background: colors.card, border: `2px solid ${colors.border}` }}
        ...
        <p style={{ color: colors.text }} className="font-pixel text-[9px] mb-1">CREATE ACCOUNT</p>
        <p style={{ color: colors.muted }} className="text-xs mb-6 font-semibold">Start your cozy journey 🌸</p>
